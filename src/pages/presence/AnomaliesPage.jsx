...
// //     setSaving(true);
// //     try {
// //       await anomalieService.updateAnomalie(anomalie.id, {
// //         ...formData,
// //         heure_reelle_entree:
...
// //   // const renderBrutes = () => {
// //   //   const pts = anomalie.pointages_bruts_json || [];
// //   //   if (isMultiple && pts.length > 0)
// //   //     return <div className="space-y-0.5">{pts.map((p, i) => <div key={i} className=" text-sm text-gray-900">{p.time}</div>)}</div>;
// //   //   return (
...
// //             className="px-1.5 py-1 bg-gray-600 text-white text-xs rounded hover:bg-gray-700"
// //           >
// //             B
// //           </button>
// //           <button
...
// //   // Les td n'ont PAS de width — c'est le colgroup qui gère tout
...
// //       </td>
// //       <td className={td}>
// //         <span className="text-sm text-gray-900">{anomalie.badgenumber}</span>
// //       </td>
// //       <td className={td}>
// //         <span className="text-sm text-gray-900">{anomalie.user_name}</span>
// //       </td>
// //       <td className={td}>
...
// //           <span
// //             className={`inline-flex px-2 py-0.5 rounded-md text-xs font-medium border ${getEtatColor(anomalie.etat)}`}
// //           >
...
// //                 onClick={handleSave}
// //                 disabled={saving}
// //                 className="p-1.5 bg-gray-800 text-white rounded-md hover:bg-gray-700 disabled:bg-gray-300"
// //               >
// //                 {saving ? (
...
//   // Figer toutes les valeurs brutes au montage — jamais modifiées après
...
//   //     result = result.map((s) => ({
//   //       ...s,
//   //       par_date: { [selectedDate]: s.par_date[selectedDate] || [] },
//   //     }));
//   //   return result;
//   // }, [sectionsData, selectedSection, selectedDate]);

//   // Remplace le useMemo filteredData existant
//   const filteredData = React.useMemo(() => {
//     const parDate = {};
...
//     {
//       label: "Non corrigées",
//       value: stats?.non_corrigees ?? "—",
//       sub: "Requiert attention",
//       dotColor: "#ef4444",
//     },
//     {
//       label: "Corrigées",
//       value: stats?.corrigees ?? "—",
//       sub: "",
//       dotColor: "#22c55e",
//     },
//     {
...
//             Utilisez "Détecter les anomalies" pour lancer une analyse.
//           </p>
//         </div>
//       ) : (
...
//                   {total} anomalie{total > 1 ? "s" : ""} · {sections.length}{" "}
...
//                         {anomalies.filter((a) => a.etat === "ok").length}{" "}
//                         corrigée(s)
//                       </span>
//                     )}
//                   </div>
