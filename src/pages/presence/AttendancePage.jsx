...
const AttendancePage = () => {
        ...
        {employees.length > 0 && (
          <div className="bg-white border-x-2 border-b-2 border-gray-800 overflow-x-auto print:overflow-visible">
            <table className="w-full border-collapse text-xs print:text-[7.5pt] print:table-fixed">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border-2 border-gray-800 p-2 sticky left-0 bg-gray-100 z-10 print:w-[120px] print:max-w-[120px]" rowSpan="4">
                    <div className="font-bold text-sm w-32 print:w-full">N° / NOM</div>
                  </th>
  ...
  <div className="flex items-baseline gap-2 print:flex-col print:gap-0">
    <span className="font-bold text-sm shrink-0">{employee.badgenumber}</span>
  ...
  {!selectedSection && (
    <div className="text-xs text-gray-400 mt-0.5 print:hidden">{employee.section}</div>
  )}
</td>
