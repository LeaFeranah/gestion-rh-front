...
const KpiCard = ({ label, value, sub, accent, onClick, loading }) => (
  ...
  >
    <div className="flex items-start justify-between">
      ...
      {accent && <span className={`w-2 h-2 rounded-full mt-1 ${accent}`} />}
    </div>
    {loading ? (
...
const DashboardPage = () => {
  ...
  return (
    ...
    >
      ...
      <PageHeader
        pageTag="Tableau de bord"
        title={`${getHourLabel()}, ${username || "..."}.`}
        ...
        kpis={[
          ...
          },
          {
            ...
            dotColor: stats.anomaliesNonCorrigees > 0 ? "#f97316" : "#d1d5db",
          },
        ]}
      />
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
          ...
          <div className="space-y-2">
            {[
              ...
              >
                <div
                  className={`w-2 h-8 rounded-full ${item.color} opacity-70 group-hover:opacity-100 transition-opacity`}
                />
          ...
          {loading ? (
                  ...
                  {recentAnomalies.map((a, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2.5 font-medium text-gray-800 truncate max-w-[140px]">
                          {a.user_name}
                        </td>
                        ...
                        <td className="py-2.5">
                          <span
                            className={`px-2 py-0.5 rounded text-xs font-medium ${state.cls}`}
                          >
                            {state.label}
                          </span>
                        </td>
            ...
            <div className="flex flex-col items-center justify-center py-10 gap-2">
              ...
              <p className="text-xs text-gray-400">
                Lancez une détection depuis la page Anomalies
              </p>
            </div>
          )}
        </div>
