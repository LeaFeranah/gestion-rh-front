          ...
          {!selectedEmployee && !showForm && (
            <div>
              ...
              {loading ? (
                ...
                /* Table View MODIFIÉE - 5 colonnes égales avec affichage prioritaire de responsable_section */
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {currentItems.map((emp) => (
                        ...
                        >
                          ...
                          {/* Colonne Section (responsable_section prioritaire) */}
                          <td className="w-1/5 px-6">
                            <div className="text-sm text-gray-900">
                ...
                /* Grid View MODIFIÉE avec priorité responsable_section */
                <div className="p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {currentItems.map((emp) => (
                      <div
