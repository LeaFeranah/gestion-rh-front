...
//   { id: 'dashboard', icon: Home, label: 'Tableau de bord', color: 'blue' },
//   { id: 'employees', icon: Users, label: 'Employés', color: 'purple' },
//   { id: 'company', icon: UserPlus, label: 'Sociétés', color: 'green' },
//   { id: 'attendance', icon: Clock, label: 'Présence', color: 'orange' },
//   { id: 'payroll', icon: DollarSign, label: 'Paie', color: 'yellow' },
//   { id: 'performance', icon: TrendingUp, label: 'Performance', color: 'indigo' },
//   { id: 'leave', icon: Calendar, label: 'Congés', color: 'teal' },
//   { id: 'documents', icon: FileText, label: 'Documents', color: 'pink' },
//   { id: 'awards', icon: Award, label: 'Récompenses', color: 'amber' },
